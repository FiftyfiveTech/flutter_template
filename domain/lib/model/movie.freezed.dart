...
class _$_Movie implements _Movie {
  const _$_Movie({required this.fact, required this.length});
  ...
  @override
  String toString() {
    return 'Movie(fact: $fact, length: $length)';
  }
...
abstract class _Movie implements Movie {
  const factory _Movie(
      {required final String fact, required final int length}) = _$_Movie;
